    ...
    <div class="container">
        <div class="row">
            ...
            if ($appointment_footer_setting['footer_social_media_enabled'] == 0) {
                ...
                $appointment_footer_googleplus = $appointment_footer_setting['footer_social_media_googleplus_link'];
                $appointment_footer_skype = $appointment_footer_setting['footer_social_media_skype_link'];
                if($appointment_footer_facebook !='' || $appointment_footer_twitter!='' || $appointment_footer_linkdin!='' ||  $appointment_footer_googleplus !='' || $appointment_footer_skype !=''){?>
                <div class="col-md-4">
                        ...
                        <?php if ($appointment_footer_setting['footer_social_media_facebook_link'] != '') { ?>
                            ...
                            <li class="linkedin"><a href="<?php echo esc_url($appointment_footer_linkdin); ?>" <?php
                                ...
                                ?> ><i class="fa fa-linkedin"></i></a></li>
                                                <?php } if ($appointment_footer_setting['footer_social_media_googleplus_link'] != '') { ?>
                            <li class="googleplus"><a href="<?php echo esc_url($appointment_footer_googleplus); ?>" <?php
                                if ($appointment_footer_setting['footer_googleplus_media_enabled'] == 1) {
                                    echo "target='_blank'";
                                }
