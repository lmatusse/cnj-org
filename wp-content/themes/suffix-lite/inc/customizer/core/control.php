 ...
 */
class Suffix_Lite_Dropdown_Taxonomies_Control extends WP_Customize_Control {
 ...
 * @see WP_Customize_Control
 */
class Suffix_Lite_Radio_Image_Control extends WP_Customize_Control {
 ...
 * @access public
 */
class Suffix_Lite_Customize_Section_Upsell extends WP_Customize_Section {
