( function( $ ) {
    ...
    $(document).ready(function () {
        ...
        function refresh_repeater_values(){
            $(".tm-repeater-field-control-wrap").each(function(){
                var values = [];
                var $this = $(this);
                ...
                $this.next('.tm-repeater-collection').val(JSON.stringify(values)).trigger('change');
            });
        }
        ...
        customize_theme_controls.on("click",'.tm-repeater-add-control-field', function(){
            var $this = $(this).parent();

            if(typeof $this !== 'undefined') {
                var field = $this.find(".tm-repeater-field-control-generator").html();
                ...
                if(typeof field !== 'undefined'){
                    ...
                    $this.find('.tm-repeater-field-control-wrap').append(field);
        ...
        $(".tm-repeater-field-control-wrap").sortable({
         ...
         */
        customize_theme_controls.on('click', '.tm-customize-icons .single-icon', function() {
            var single_icon = $(this),
                at_customize_icons = single_icon.closest( '.tm-customize-icons' ),
            ...
            at_customize_icons.find('.tm-icon-value').val( icon_value );
            at_customize_icons.find('.icon-preview').html('<i class="' + icon_display_value + '"></i>');
            at_customize_icons.find('.tm-icon-value').trigger('change');
        });

        customize_theme_controls.on('click', '.tm-customize-icons .icon-toggle ,.pt-customize-icons .icon-preview', function() {
            var icon_toggle = $(this),
                at_customize_icons = icon_toggle.closest( '.tm-customize-icons' ),
        ...
        customize_theme_controls.on('keyup', '.tm-customize-icons .icon-search', function() {
            var text = $(this),
                value = this.value,
                at_customize_icons = text.closest( '.tm-customize-icons' ),
                icons_list_wrapper = at_customize_icons.find( '.icons-list-wrapper' );
