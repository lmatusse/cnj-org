...
(function() {
    ...
    sa.prototype.load = function(a) {
            ...
            if (e["__mti_fntLst" + c]) {
                ...
                if (d)
                    for (var h = 0; h < d.length; h++) {
                        var m = d[h].fontfamily;
                        void 0 != d[h].fontStyle && void 0 != d[h].fontWeight ? (k = d[h].fontStyle + d[h].fontWeight, g.push(new H(m, k))) : g.push(new H(m))
                    }
                a(g)
        ...
        if (c) {
            var e = this.c.m;
            B(this.c, ta(this, c, d), function(d) {
                d ? a([]) : b()
