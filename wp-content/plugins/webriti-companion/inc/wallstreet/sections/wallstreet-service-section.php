                    ...
                    <div class="row <?php echo $service_row_class; ?>">
                        ...
                        for ($i = 0; $i < 3; $i++) {
                            if ($service_image_array[$i] || $service_title_array[$i] || $service_description_array[$i]) {
                                if ($service_child_type!='default' && $theme->name == 'Leo' && version_compare(wp_get_theme()->get('Version'), '1.2.4') > 0 || $service_child_type!='default' && $theme->name == 'Bluestreet' && version_compare(wp_get_theme()->get('Version'), '1.2.7') > 0 ) {?>
